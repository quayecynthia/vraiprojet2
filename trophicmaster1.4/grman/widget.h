...
class WidgetCheckBox : public Widget
{
    ...
    public :
        ...
        bool get_population() { return m_population; }
        void set_population(bool population) { m_population = population; }
};
...
class WidgetButton : public Widget
{
    ...
    public :
        ...
        bool clicked() { bool clk = m_population; m_population=false; return clk; }
        bool get_population() { return m_population; }
        void set_population(bool population) { m_population = population; }
};
...
class WidgetVSlider : public Widget
{
    ...
    public :
        ...
        double get_population() { return typed(m_population); }
        void limit_to_range() { if (m_population<m_min) m_population=m_min; if (m_population>m_max) m_population=m_max; }
        void set_population(double population) { m_population = population; m_population =get_population(); limit_to_range(); }
...
class WidgetImage : public Widget
{
    ...
    public :
        ...
        std::string get_pic_name(){return m_pic_name;} ///getteur de nom de l'image
